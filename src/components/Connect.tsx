...
export default function Contact() {
      ...
      const handleSubmit = async (e: Event) => {
        ...
        try {
          ...
          if (response.status === 200) {
            showMessage(
              "Thank you! Your message has been sent successfully. Kadir will get back to you soon.",
              true,
            );
            contactForm.reset();
          } else {
  ...
  return (
    <>
      <section
        id="contact"
        className="w-full bg-neutral-950 text-white pt-10 sm:pt-10 lg:pt-15 pb-5 sm:pb-10 lg:pb-10"
      >
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="grid gap-10 lg:gap-16 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="space-y-5">
              <p className="text-xs tracking-[0.22em] uppercase text-amber-400">
                Connect with me
              </p>
              <h2
              ...
              <p className="text-base sm:text-lg text-white/75 mb-8">
                If you’re leading change and want it to actually stick, <br />
                Let&apos;s talk.
              </p>
              ...
              <div className="flex flex-col sm:flex-col justify-center gap-6 mb-8">
                <a
                  ...
                  className="text-lg font-medium text-white hover:text-amber-400 transition focus-ring hover-lift"
                  aria-label="Email"
                >
                  me@kadrisalami.com
                </a>
                <div className="flex items-center gap-4 text-sm text-white/75">
                  <a
                    ...
                    className="transition-all hover:text-amber-400 duration-300 hover:scale-110 focus-ring hover-lift"
                  ...
                  <a
                    ...
                    className="transition-all duration-300 hover:text-amber-400 hover:scale-110 focus-ring hover-lift"
                    aria-label="LinkedIn"
                  >
                    <svg
                      className="w-5 h-5"
            ...
            <div className="space-y-6">
                  ...
                  <form ref={formRef} className="space-y-4">
                    ...
                    <div className="text-center mb-6">
                      ...
                      <p className="text-sm text-white/60">
                        Your message will be delivered directly to Kadir.
                      </p>
                    </div>
                    ...
                    <div className="pt-2">
                      ...
                      >
                        ...
                        <span ref={btnLoadingRef} className="hidden">
                          <svg
                            className="animate-spin -ml-1 mr-3 h-5 w-5 text-neutral-900 inline"
                    ...
                    <div
                      ref={formMessageRef}
                      className="hidden rounded-lg p-4 text-sm font-medium transition-all duration-300"
                    ></div>
                  </form>
                </div>
              </div>
              ...
              <div className="mt-16 pt-8 border-t border-white/10">
                <div className="flex flex-col sm:flex-row items-center justify-between text-xs text-white/50">
                  <span>Kadir Salami · <span className="text-amber-400">2026</span></span>
                  <button
                    onClick={scrollToTop}
                    type="button"
                  ...
                  >
                    <span className="text-amber-700 font-bold">Back to top</span>
                    <span className="text-amber-900 font-extrabold text-[15px]" aria-hidden>↑</span>
                  </button>
                </div>
              </div>
            </div>
